...
function handleReplaceImage() {
  MessagePlugin.info('请选择本地文件进行图片更换')
}
</script>
        ...
        <div class="form-grid">
          ...
          <div class="form-group">
            ...
            <div style="display: flex; gap: 10px; align-items: center;">
              ...
              <button class="btn btn-sm btn-outline" @click="handleReplaceImage">更换图片</button>
            </div>
          </div>
...
.cover-preview {
  ...
  height: 80px;
  border-radius: 8px;
  background: linear-gradient(135deg, #1A2332, var(--primary-500));
  display: flex;
  align-items: center;
