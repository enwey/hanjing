...
const handleCallToConsult = (item: QueueItem) => {
  ...
  // Auto-promote item status to confirmed (active) if it was pending
  if (item.status === 'pending') {
    openCheckInDialog(item)
  } else {
    // If already confirmed (signed-in), it becomes the current patient automatically
    ...
    <div class="workbench-layout">
      ...
      <div class="workbench-left panel">
        <div class="pane-header">
          <div class="pane-title">🔊 当前诊室接诊中</div>
